export const ru = {
  meta: {
    title: "QueueCRM — управление очередями через WhatsApp и Telegram",
    description: "Управляй очередями и клиентами через WhatsApp или Telegram. Без приложения. Для моек, СТО, салонов.",
  },
  nav: {
  ...
  hero: {
    ...
    subheadline: "Управление очередями через WhatsApp или Telegram. Без приложения. Работает на любом телефоне.",
  ...
  howItWorks: {
    ...
    step1desc: "Пишет в WhatsApp или Telegram, или сканирует QR-код на входе",
    ...
    items: [
      {
        ...
        a: "Нет. Всё работает через WhatsApp или Telegram, которые уже установлены.",
      },
      {
        q: "Как клиент встаёт в очередь?",
        a: "Сканирует QR-код на входе или пишет в WhatsApp / Telegram бот напрямую.",
      },
      {
        q: "Какие языки поддерживаются?",
        a: "Арабский, английский и русский. Каждый бизнес сам выбирает нужные языки.",
      },
      {
        q: "Можно ли использовать Telegram вместо WhatsApp?",
        a: "Да. Telegram — опциональный канал рядом с WhatsApp. Настраивается в разделе Settings.",
      },
      {
